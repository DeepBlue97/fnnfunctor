...
from fnnfunctor import *
from fnnfunctor.utils.device import to_cpu
...
def compute_loss(predictions, targets, yolo_layer_anchors):
    ...
    # Build yolo targets
    tcls, tbox, indices, anchors = build_targets(predictions, targets, yolo_layer_anchors)  # targets
    ...
    for layer_index, layer_predictions in enumerate(predictions):
        ...
        # lobj += BCEobj(layer_predictions[..., 4], tobj) # obj loss   # ori 
        lobj += BCEobj(layer_predictions[..., 4].sigmoid(), tobj) # obj loss
...
def build_targets(p, targets, yolo_layer_anchors):
    ...
    for i, anchors in enumerate(yolo_layer_anchors):
